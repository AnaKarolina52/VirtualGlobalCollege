...
class TeacherUpdate implements ActionListener {
    ...
    TeacherUpdate() {
        ...
        JLabel id15 = new JLabel("Enter employee id to update the data of teacher");
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submitBtn) {
            try {
                ...
                str.append("UPDATE `college1`.`teacher` SET ");
                ...
                str.append("WHERE `id_teacher` = " + idText.getText() + ";");
        ...
        if (ae.getSource() == updateBtn) {
            try {
                datacom con = new datacom();
                String str = "select name,dob,address,phone,email from teacher where id_teacher = " + idText.getText();
