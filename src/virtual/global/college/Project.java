...
public class Project extends JFrame implements ActionListener {
    ...
    Project() {
        super("Virtual Global College");

        setSize(1920, 1030);

        ImageIcon ic = new ImageIcon(ClassLoader.getSystemResource("virtual/global/college/icons/pictures/third.jpg"));
        ...
        JMenu admissions = new JMenu("Admissions");
        JMenuItem m1 = new JMenuItem("New Teacher");
        JMenuItem m2 = new JMenuItem("New Students");
        admissions.setForeground(Color.BLUE);

        m1.setFont(new Font("monospaced", Font.BOLD, 16));
        ImageIcon icon1 = new ImageIcon(ClassLoader.getSystemResource("virtual/global/college/icons/pictures/icon1.png"));
        ...
        ImageIcon icon2 = new ImageIcon(ClassLoader.getSystemResource("virtual/global/college/icons/pictures/icon2.png"));
        ...
        ImageIcon icon4 = new ImageIcon(ClassLoader.getSystemResource("virtual/global/college/icons/pictures/icon3.png"));
        ...
        ImageIcon icon5 = new ImageIcon(ClassLoader.getSystemResource("virtual/global/college/icons/pictures/icon4.jpg"));
        ...
        ImageIcon icon23 = new ImageIcon(ClassLoader.getSystemResource("virtual/global/college/icons/pictures/icon14.jpg"));
        ...
        ImageIcon icon27 = new ImageIcon(ClassLoader.getSystemResource("virtual/global/college/icons/pictures/icon15.png"));
        ...
        ImageIcon icon30 = new ImageIcon(ClassLoader.getSystemResource("virtual/global/college/icons/pictures/icon16.png"));
        ...
        ImageIcon icon32 = new ImageIcon(ClassLoader.getSystemResource("virtual/global/college/icons/pictures/icon17.png"));
        ...
        ImageIcon icon7 = new ImageIcon(ClassLoader.getSystemResource("virtual/global/college/icons/pictures/icon5.png"));
        ...
        ImageIcon iconn = new ImageIcon(ClassLoader.getSystemResource("virtual/global/college/icons/pictures/icon6.png"));
        ...
        ImageIcon icon14 = new ImageIcon(ClassLoader.getSystemResource("virtual/global/college/icons/pictures/icon7.png"));
        Image image15 = icon14.getImage().getScaledInstance(20, 20, Image.SCALE_DEFAULT);

        s2.setFont(new Font("monospaced", Font.BOLD, 16));
        ImageIcon icon16 = new ImageIcon(ClassLoader.getSystemResource("virtual/global/college/icons/pictures/icon8.png"));
        ...
        ImageIcon icon11 = new ImageIcon(ClassLoader.getSystemResource("virtual/global/college/icons/pictures/icon12.png"));
    ...
    public void actionPerformed(ActionEvent ae) {
      ...
      //  } else if (msg.equals("Web Browser")) {
            ...
            new StudentPresence().setVisible(true);
            ...
            new ExamInformation().setVisible(true);
